...
export const PROJECT_INFO = {
  ...
  positioning: "A premium destination for business, retail and contemporary living in Lucknow.",
  locationShort: "Kursi Road | Jankipuram Extension, Lucknow",
...
export const SPACES_CATEGORIES = [
  {
    ...
    features: [
      "High Frontage & Prominent Visibility",
      "Lower Ground & Upper Ground Levels",
      "Wide Pedestrian Walkways & Grand Corridors",
      "Dedicated Loading & Utility Provisions",
      "Ideal for Flagships, Boutiques, Salons & Cafés"
    ],
  ...
  },
  {
    ...
    tagline: "More Than an Office. A Statement.",
    description: "Workspaces designed around productivity, flexibility and a premium business experience. Y2R Heights offers self-contained office units, flexible configurations, natural light and layouts designed to minimise wasted space—suited to founders, consultants, professionals and growing businesses.",
    highlight: "Customisable Offices • Natural Light • Efficient Floor Plans",
    features: [
      "Customisable Flexible Layouts",
      "Maximum Natural Light Inflow",
      "Efficient Minimal-Wastage Floor Plates",
      "High-Speed Vertical Transit",
      "Suited for Founders, Consultants & Firms"
    ],
  ...
  },
  {
    ...
    description: "Thoughtfully planned studio apartments combining contemporary design, functionality and everyday convenience. Ideal for professionals, business travellers and modern urban lifestyles. Studio/service apartments are located on the 3rd to 7th floors.",
    highlight: "Contemporary Design • 3rd to 7th Floors • Prime Convenience",
    features: [
      "Located on 3rd to 7th Floors",
      "Smart Contemporary Space Planning",
      "Ideal for Urban Professionals & Travellers",
      "Panoramic Views & Optimal Ventilation",
      "Dedicated Lift & Secure Access"
    ],
  ...
  },
  {
    ...
    description: "A vibrant culinary destination created for modern F&B brands. Generous counter frontage, planned circulation, service and ventilation zones, along with communal seating, create an environment designed to serve both customers and operators efficiently.",
    highlight: "QSR • Café • Desserts • Regional Cuisine • Dining Concepts",
    features: [
      "Generous Brand Counter Frontages",
      "Dedicated Exhaust & Kitchen Ventilation",
      "Optimized Patron Circulation & Seating",
      "Wide F&B Brand Categories",
      "High Footfall Dining Destination"
    ],
  ...
  },
  {
    ...
    description: "Flexible spaces for larger business and hospitality requirements, banquets, and corporate conferences on the dedicated Second Floor.",
    highlight: "Flexible Configurations • Second Floor • Hospitality Ready",
    features: [
      "Dedicated 2nd Floor Banquet Hall",
      "High Ceilings & Clear Spans",
      "Spacious Guest Circulation & Foyer",
      "Integrated Service Backstage",
      "Versatile Event Configurations"
    ],
...
export const CONNECTIVITY_DATA = [
  ...
  { destination: "Sitapur Road", time: "5 Mins", distance: "3.5 km", type: "Arterial" },
